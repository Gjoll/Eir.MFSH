...
public partial class FSHParser : Parser {
	...
	public const int
		...
		RULE_codeSystem = 13, RULE_csMetadata = 14, RULE_ruleSet = 15, RULE_ruleSetMixin = 16, 
		...
		RULE_mixin = 29, RULE_source = 30, RULE_target = 31, RULE_sequence = 32, 
		RULE_cardRule = 33, RULE_flagRule = 34, RULE_valueSetRule = 35, RULE_fixedValueRule = 36, 
		RULE_containsRule = 37, RULE_onlyRule = 38, RULE_obeysRule = 39, RULE_caretValueRule = 40, 
		RULE_mappingRule = 41, RULE_vsComponent = 42, RULE_vsConceptComponent = 43, 
	...
	public static readonly string[] ruleNames = {
		...
		"vsMetadata", "codeSystem", "csMetadata", "ruleSet", "ruleSetMixin", "mapping", 
		"mappingMetadata", "parent", "id", "title", "description", "expression", 
		"xpath", "severity", "instanceOf", "usage", "mixins", "mixin", "source", 
		"target", "sequence", "cardRule", "flagRule", "valueSetRule", "fixedValueRule", 
		"containsRule", "onlyRule", "obeysRule", "caretValueRule", "mappingRule", 
	...
	public SdRuleContext sdRule() {
		...
		try {
			...
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 194; valueSetRule();
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
				{
				State = 195; fixedValueRule();
				}
				break;
			case 5:
				EnterOuterAlt(_localctx, 5);
				{
				State = 196; containsRule();
				}
				break;
			case 6:
				EnterOuterAlt(_localctx, 6);
	...
	public RuleSetMixinContext ruleSetMixin() {
		...
		EnterRule(_localctx, 32, RULE_ruleSetMixin);
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public TitleContext title() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 314; Match(KW_TITLE);
			State = 315; Match(STRING);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public DescriptionContext description() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 317; Match(KW_DESCRIPTION);
			State = 318;
			_la = TokenStream.LA(1);
	...
	public SeverityContext severity() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 326; Match(KW_SEVERITY);
			State = 327; Match(CODE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public MixinContext mixin() {
		...
		EnterRule(_localctx, 58, RULE_mixin);
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 344; Match(SEQUENCE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public SourceContext source() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 346; Match(KW_SOURCE);
			State = 347; Match(SEQUENCE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public CardRuleContext cardRule() {
		...
		EnterRule(_localctx, 66, RULE_cardRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public FlagRuleContext flagRule() {
		...
		EnterRule(_localctx, 68, RULE_flagRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public ValueSetRuleContext valueSetRule() {
		...
		EnterRule(_localctx, 70, RULE_valueSetRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			...
			if (_la==KW_UNITS) {
				{
				State = 375; Match(KW_UNITS);
				}
			}

			State = 378; Match(KW_FROM);
			State = 379; Match(SEQUENCE);
			State = 381;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
	...
	public FixedValueRuleContext fixedValueRule() {
		...
		EnterRule(_localctx, 72, RULE_fixedValueRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			...
			if (_la==KW_UNITS) {
				{
				State = 385; Match(KW_UNITS);
				}
			}

			State = 388; Match(EQUAL);
			State = 389; value();
			State = 391;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
	...
	public ContainsRuleContext containsRule() {
		...
		EnterRule(_localctx, 74, RULE_containsRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 393; Match(STAR);
			State = 394; path();
			State = 395; Match(KW_CONTAINS);
			State = 396; item();
			State = 401;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
	...
	public OnlyRuleContext onlyRule() {
		...
		EnterRule(_localctx, 76, RULE_onlyRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			...
			while (_la==KW_OR) {
				{
				{
				State = 408; Match(KW_OR);
				State = 409; targetType();
				}
				}
				State = 414;
				ErrorHandler.Sync(this);
	...
	public ObeysRuleContext obeysRule() {
		...
		EnterRule(_localctx, 78, RULE_obeysRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			...
			State = 419; Match(KW_OBEYS);
			State = 420; Match(SEQUENCE);
			State = 425;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (_la==KW_AND) {
				{
				{
				State = 421; Match(KW_AND);
				State = 422; Match(SEQUENCE);
				}
				}
				State = 427;
				ErrorHandler.Sync(this);
	...
	public CaretValueRuleContext caretValueRule() {
		...
		EnterRule(_localctx, 80, RULE_caretValueRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public MappingRuleContext mappingRule() {
		...
		EnterRule(_localctx, 82, RULE_mappingRule);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 436; Match(STAR);
			State = 438;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==KW_SYSTEM || _la==SEQUENCE) {
	...
	public VsComponentContext vsComponent() {
		...
		try {
			...
			case COMMA_DELIMITED_CODES:
				{
				State = 452; vsConceptComponent();
				}
				break;
			case KW_CODES:
				{
				State = 453; vsFilterComponent();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public VsConceptComponentContext vsConceptComponent() {
		...
		try {
			...
			case COMMA_DELIMITED_CODES:
				EnterOuterAlt(_localctx, 2);
				{
				State = 460; Match(COMMA_DELIMITED_CODES);
				State = 461; vsComponentFrom();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public VsFilterComponentContext vsFilterComponent() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 464; Match(KW_CODES);
			State = 465; vsComponentFrom();
			State = 468;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==KW_WHERE) {
				{
				State = 466; Match(KW_WHERE);
				State = 467; vsFilterList();
				}
			}
	...
	public VsComponentFromContext vsComponentFrom() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 470; Match(KW_FROM);
			State = 481;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case KW_SYSTEM:
				{
				State = 471; vsFromSystem();
				State = 474;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==KW_AND) {
					{
					State = 472; Match(KW_AND);
	...
	public VsFromSystemContext vsFromSystem() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 483; Match(KW_SYSTEM);
			State = 484; Match(SEQUENCE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public VsFromValuesetContext vsFromValueset() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 486; Match(KW_VSREFERENCE);
			State = 487;
			_la = TokenStream.LA(1);
		...
		try {
			...
			while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					State = 489; vsFilterDefinition();
					State = 490; Match(KW_AND);
					}
					} 
				}
				State = 496;
	...
	public VsFilterValueContext vsFilterValue() {
		...
		try {
			...
			case KW_TRUE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 507; Match(KW_TRUE);
				}
				break;
			case KW_FALSE:
				EnterOuterAlt(_localctx, 3);
				{
				State = 508; Match(KW_FALSE);
				}
				break;
			case REGEX:
				EnterOuterAlt(_localctx, 4);
				{
				State = 509; Match(REGEX);
				}
				break;
			case STRING:
				EnterOuterAlt(_localctx, 5);
				{
				State = 510; Match(STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public PathsContext paths() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 515; Match(COMMA_DELIMITED_SEQUENCES);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public CaretPathContext caretPath() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 517; Match(CARET_SEQUENCE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public ValueContext value() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 523; Match(SEQUENCE);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 524; Match(STRING);
				}
				break;
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 525; Match(MULTILINE_STRING);
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
			...
			case 5:
				EnterOuterAlt(_localctx, 5);
				{
				State = 527; Match(DATETIME);
				}
				break;
			case 6:
				EnterOuterAlt(_localctx, 6);
				{
				State = 528; Match(TIME);
				}
				break;
			case 7:
				EnterOuterAlt(_localctx, 7);
	...
	public ItemContext item() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 536; Match(SEQUENCE);
			State = 539;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==KW_NAMED) {
				{
				State = 537; Match(KW_NAMED);
				State = 538; Match(SEQUENCE);
				}
			}

			State = 541; Match(CARD);
			State = 545;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << KW_MOD) | (1L << KW_MS) | (1L << KW_SU) | (1L << KW_TU) | (1L << KW_NORMATIVE) | (1L << KW_DRAFT))) != 0)) {
	...
	public QuantityContext quantity() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 557; Match(NUMBER);
			State = 558; Match(UNIT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public ReferenceContext reference() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 564; Match(REFERENCE);
			State = 566;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==STRING) {
				{
				State = 565; Match(STRING);
				}
			}
	...
	private static char[] _serializedATN = {
		...
		'\x5', '\x3', '\x5', '\x6', '\x5', '\xA4', '\n', '\x5', '\r', '\x5', '\xE', 
		'\x5', '\xA5', '\x3', '\x5', '\a', '\x5', '\xA9', '\n', '\x5', '\f', '\x5', 
		'\xE', '\x5', '\xAC', '\v', '\x5', '\x3', '\x6', '\x3', '\x6', '\x3', 
		'\x6', '\a', '\x6', '\xB1', '\n', '\x6', '\f', '\x6', '\xE', '\x6', '\xB4', 
		'\v', '\x6', '\x3', '\x6', '\a', '\x6', '\xB7', '\n', '\x6', '\f', '\x6', 
		...
		'\f', '\t', '\xE', '\t', '\xD9', '\v', '\t', '\x3', '\n', '\x3', '\n', 
		'\x3', '\n', '\x3', '\n', '\x3', '\n', '\x5', '\n', '\xE0', '\n', '\n', 
		'\x3', '\v', '\x3', '\v', '\x3', '\v', '\x6', '\v', '\xE5', '\n', '\v', 
		'\r', '\v', '\xE', '\v', '\xE6', '\x3', '\f', '\x3', '\f', '\x3', '\f', 
		'\x3', '\f', '\x5', '\f', '\xED', '\n', '\f', '\x3', '\r', '\x3', '\r', 
		'\x3', '\r', '\a', '\r', '\xF2', '\n', '\r', '\f', '\r', '\xE', '\r', 
		'\xF5', '\v', '\r', '\x3', '\r', '\x3', '\r', '\a', '\r', '\xF9', '\n', 
		'\r', '\f', '\r', '\xE', '\r', '\xFC', '\v', '\r', '\x3', '\xE', '\x3', 
		'\xE', '\x3', '\xE', '\x5', '\xE', '\x101', '\n', '\xE', '\x3', '\xF', 
		'\x3', '\xF', '\x3', '\xF', '\a', '\xF', '\x106', '\n', '\xF', '\f', '\xF', 
		'\xE', '\xF', '\x109', '\v', '\xF', '\x3', '\xF', '\x3', '\xF', '\a', 
		'\xF', '\x10D', '\n', '\xF', '\f', '\xF', '\xE', '\xF', '\x110', '\v', 
		'\xF', '\x3', '\x10', '\x3', '\x10', '\x3', '\x10', '\x5', '\x10', '\x115', 
		'\n', '\x10', '\x3', '\x11', '\x3', '\x11', '\x3', '\x11', '\x3', '\x11', 
		'\x6', '\x11', '\x11B', '\n', '\x11', '\r', '\x11', '\xE', '\x11', '\x11C', 
		'\x3', '\x12', '\x3', '\x12', '\x3', '\x12', '\x3', '\x13', '\x3', '\x13', 
		'\x3', '\x13', '\a', '\x13', '\x125', '\n', '\x13', '\f', '\x13', '\xE', 
		'\x13', '\x128', '\v', '\x13', '\x3', '\x13', '\a', '\x13', '\x12B', '\n', 
		'\x13', '\f', '\x13', '\xE', '\x13', '\x12E', '\v', '\x13', '\x3', '\x14', 
		...
		'\x32', '\x3', '\x32', '\x3', '\x32', '\a', '\x32', '\x1EF', '\n', '\x32', 
		'\f', '\x32', '\xE', '\x32', '\x1F2', '\v', '\x32', '\x3', '\x32', '\x3', 
		'\x32', '\x3', '\x33', '\x3', '\x33', '\x3', '\x33', '\x5', '\x33', '\x1F9', 
		'\n', '\x33', '\x3', '\x34', '\x3', '\x34', '\x3', '\x35', '\x3', '\x35', 
		'\x3', '\x35', '\x3', '\x35', '\x3', '\x35', '\x5', '\x35', '\x202', '\n', 
		...
		'\t', '\x3', '\x2', '\x37', '\x38', '\x3', '\x2', '\x44', '\x45', '\x4', 
		'\x2', '\x32', '\x32', '\x45', '\x45', '\x4', '\x2', '/', '/', '\x45', 
		'\x45', '\x3', '\x2', '\x18', '\x1D', '\x3', '\x2', '\x1F', '\"', '\x3', 
		'\x2', ')', '*', '\x2', '\x264', '\x2', '\x8B', '\x3', '\x2', '\x2', '\x2', 
		'\x4', '\