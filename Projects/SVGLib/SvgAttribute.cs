...
namespace SVGLib
{
    ...
    public class SvgAttribute
    {
        ...
        private void InitXLink()
        {
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarkerWidth;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "markerWidth";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarkerHeight;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "markerHeight";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarkerUnits;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "markerUnits";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrRefX;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "refX";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrRefY;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "refY";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrOrient;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "orient";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarkerStart;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "marker-start";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarkerEnd;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "marker-end";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarkerMid;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "marker-mid";
            ...
            // ---
            info = new _AttrInfo();
            info._type = _SvgAttribute.attrMarker;
            info._group = _SvgAttributeGroup.groupXLink;
            info._name = "marker";
