...
namespace SVGLib
{
	...
	public class SvgBasicShape : SvgElement
	{
		...
		public Color Color
		{
			get => GetAttributeColorValue(SvgAttribute._SvgAttribute.attrPaint_Color);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_Color, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrOpacity_Opacity);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrOpacity_Opacity, value);
		}
		...
		public Color Fill
		{
			get => GetAttributeColorValue(SvgAttribute._SvgAttribute.attrPaint_Fill);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_Fill, value);
		}
		...
		{
			get => (SvgAttribute._SvgFillRule)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrPaint_FillRule);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_FillRule, (int)value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrOpacity_FillOpacity);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrOpacity_FillOpacity, value);
		}
		...
		public Color Stroke
		{
			get => GetAttributeColorValue(SvgAttribute._SvgAttribute.attrPaint_Stroke);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_Stroke, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrOpacity_StrokeOpacity);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrOpacity_StrokeOpacity, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrPaint_StrokeWidth);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_StrokeWidth, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrPaint_StrokeDashArray);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_StrokeDashArray, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrPaint_StrokeDashOffSet);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_StrokeDashOffSet, value);
		}
		...
		{
			get => (SvgAttribute._SvgLineCap)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrPaint_StrokeLineCap);

			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_StrokeLineCap, (int)value);
		}
		...
		{
			get => (SvgAttribute._SvgLineJoin)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrPaint_StrokeLineJoin);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_StrokeLineJoin, (int)value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrPaint_StrokeMiterLimit);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_StrokeMiterLimit, value);
		}
		...
		{
			get => (SvgAttribute._SvgColorInterpolation)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrPaint_ColorInterpolation);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_ColorInterpolation, (int)value);
		}
		...
		{
			get => (SvgAttribute._SvgColorInterpolation)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrPaint_ColorInterpolationFilters);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_ColorInterpolationFilters, (int)value);
		}
		...
		public SvgAttribute._SvgColorRendering ColorRendering
		{
			...
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrPaint_ColorRendering, (int)value);
		}
		...
		{
			get => (SvgAttribute._SvgGraphicsDisplay)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrGraphics_Display);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrGraphics_Display, (int)value);
		}
		...
		{
			get => (SvgAttribute._SvgImageRendering)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrGraphics_ImageRendering);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrGraphics_ImageRendering, (int)value);
		}
		...
		{
			get => (SvgAttribute._SvgShapeRendering)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrGraphics_ShapeRendering);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrGraphics_ShapeRendering, (int)value);
		}
		...
		public SvgAttribute._SvgTextRendering TextRendering
		{
			...
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrGraphics_TextRendering, (int)value);
		}
		...
		{
			get => (SvgAttribute._SvgVisibility)GetAttributeIntValue(SvgAttribute._SvgAttribute.attrGraphics_Visiblity);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrGraphics_Visiblity, (int)value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrMarkerStart);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrMarkerStart, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrMarkerEnd);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrMarkerEnd, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrMarker);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrMarker, value);
		}
		...
		{
			get => GetAttributeStringValue(SvgAttribute._SvgAttribute.attrMarkerMid);
			set => SetAttributeValue(SvgAttribute._SvgAttribute.attrMarkerMid, value);
		}
		...
		protected SvgBasicShape(SvgDoc doc):base(doc)
		{
			...
			AddAttr(SvgAttribute._SvgAttribute.attrMarker, null);
			AddAttr(SvgAttribute._SvgAttribute.attrMarkerEnd, null);
			AddAttr(SvgAttribute._SvgAttribute.attrMarkerStart, null);
			AddAttr(SvgAttribute._SvgAttribute.attrMarkerMid, null);
		}
	}
}
